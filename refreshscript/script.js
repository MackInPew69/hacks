// ==UserScript==
// @name         Refresh PC Global Version
// @namespace    http://tampermonkey.net/
// @version      2024-03-15
// @description  try to take over the world!
// @author       MackInPew
// @match        https://qxbroker.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=qxbroker.com
// @grant        none
// ==/UserScript==
...
setInterval(function(){
    ...
    let elm1 = document.getElementsByClassName("sidebar__button")[0];
    elm1.setAttribute("id", "real");
    let elm2 = document.getElementsByClassName("sidebar__button")[1];
    elm2.setAttribute("id", "demo");
    let eler = document.getElementById("real");
    eler.classList.add("active");
    //let eled = document.getElementById("demo");
    //eled.classList.remove("active");
    ...
    let percent1 = parseInt(
        document
        .getElementsByClassName(
            "trading-chart__mobile-select section-deal__mobile-select"
        )[0]
        .getElementsByClassName("trading-chart__mobile-select__percent")[0]
        .innerHTML
    );
    ...
    setInterval(function () {
        ...
        let total_profit = input_blc + input_blc * (av1 / 100);
        ...
        document
            ...
            .getElementsByClassName(
            "trading-chart__mobile-select__percent"
        )[0].innerHTML = av1 + "%";

        document.getElementsByClassName("section-deal__mobile-payout ")[0].innerHTML =
            'Payout: <div class="section-deal__mobile-payout__border"></div><b>' +
            total_profit +
            "$</b>";
    }, 1000);
